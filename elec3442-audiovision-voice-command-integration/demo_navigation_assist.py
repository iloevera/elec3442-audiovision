...
def run_demo() -> None:
    ...
    # --- Voice command setup ---
    COMMANDS = {
        "enable object avoidance": "enable object avoidance",
        "disable object avoidance": "disable object avoidance",
        "enable tripping hazards": "enable tripping hazards",
        "disable tripping hazards": "disable tripping hazards",
        "enable path finding": "enable path finding",
        "disable path finding": "disable path finding"
    }
    vosk_model_path = "/home/e3b/elec3442-audiovision/elec3442-audiovision-voice-command-integration/vosk-model-small-en-us-0.15"  
